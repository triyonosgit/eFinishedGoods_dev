...
class MY_Model extends CI_Model
{
    ...
    public function get_all_num_rows($rules)
    {
        if (is_null($rules)) {
    ...
    // Membuat paging.
    function paging($tipe, $base_url, $uri_segment, $criteria = null)
    {
        ...
        if ($tipe == 'pencarian') {
            ...
            $config['total_rows'] = $this->cari_num_rows($criteria);
        } else {
            $config['first_url'] = '1';
            $config['total_rows'] = $this->get_all_num_rows($criteria);
        }
