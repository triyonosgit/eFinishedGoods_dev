<div class="container">
    ...
    <?php echo form_open($form_action, array('id'=>'myform', 'class'=>'myform', 'role'=>'form')) ?>
        ...
        <div class="form-group has-feedback <?php set_validation_style('username')?>">
            ...
            <?php echo form_input('username', $values->username, 'id="username" class="form-control" placeholder="Username" maxlength="45"') ?>
        ...
        <div class="form-group has-feedback <?php set_validation_style('passconf')?>">
            ...
            <?php echo form_password('passconf', $values->passconf, 'id="passconf" class="form-control" placeholder="Konfirmasi Password" maxlength="45"') ?>
