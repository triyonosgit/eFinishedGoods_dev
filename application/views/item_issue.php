...
<div class="container">
    ...
    <?php echo form_open($form_action, array('id'=>'myform', 'class'=>'myform', 'role'=>'form')) ?>
        ...
        <!-- No Surat Jalan Pengiriman -->
        <div class="form-group has-feedback <?php set_validation_style('reference')?>">
            <?php echo form_label('No Surat Jalan Pengiriman', 'reference', array('class' => 'control-label')) ?>
            <?php echo form_input('reference', $values->reference, 'id="reference" class="form-control" placeholder="No Surat Jalan Pengiriman" maxlength="60"') ?>
            <?php set_validation_icon('reference') ?>
            <?php echo form_error('reference', '<span class="help-block">', '</span>');?>
        </div>

        <!-- Transporter / No Polisi -->
        <div class="form-group has-feedback <?php set_validation_style('vendor')?>">
            <?php echo form_label('Transporter / No Polisi', 'vendor', array('class' => 'control-label')) ?>
            <?php echo form_input('vendor', $values->vendor, 'id="vendor" class="form-control" placeholder="Transporter / No Polisi" maxlength="90"') ?>
