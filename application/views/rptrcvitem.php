...
<!-- <div class="container"> -->
    <div class="row">
        <div class="col-sm-12">
            <h3 class="page-header">Received Items </h3>

            <form method="POST" id="filter_panel" action="getReceivedItems">
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Tanggal Received</label>
                    <div class="col-sm-2">
                    ...
                    <table id="dtlissitems" class="table table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $t->wonbr; ?></td>
                                <td><?php echo $t->spknbr; ?></td>
                                <td><?php echo $t->packnbr; ?></td>
