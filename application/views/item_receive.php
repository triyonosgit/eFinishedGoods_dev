...
<div class="container">
    ...
    <?php echo form_open($form_action, array('id'=>'myform', 'class'=>'myform', 'role'=>'form')) ?>
        ...
        <!-- No Bukti Serah Terima Barang -->
        <div class="form-group has-feedback <?php set_validation_style('reference')?>">
            <?php echo form_label('No Bukti Serah Terima Barang', 'reference', array('class' => 'control-label')) ?>
            <?php echo form_input('reference', $values->reference, 'id="reference" class="form-control" placeholder="No Bukti Serah Terima Barang" maxlength="60"') ?>
        ...
        <div class="form-group has-feedback <?php set_validation_style('vendor')?>">
            <?php echo form_label('Referensi', 'vendor', array('class' => 'control-label')) ?>
            <?php echo form_input('vendor', $values->vendor, 'id="vendor" class="form-control" placeholder="Referensi" maxlength="90"') ?>
