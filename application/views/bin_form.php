...
<div class="container">
    ...
    <?php echo form_open($form_action, array('id'=>'myform', 'class'=>'myform', 'role'=>'form')) ?>
        ...
        <div class="form-group has-feedback <?php set_validation_style('block')?>">
            ...
            <?php echo form_input('block', $values->block, 'id="block" class="form-control" placeholder="Block" maxlength="2"') ?>
        ...
        <div class="form-group has-feedback <?php set_validation_style('column')?>">
            ...
            <?php echo form_input('column', $values->column, 'id="column" class="form-control" placeholder="Column" maxlength="3"') ?>
        ...
        <div class="form-group has-feedback <?php set_validation_style('level')?>">
            ...
            <?php echo form_input('level', $values->level, 'id="level" class="form-control" placeholder="Level" maxlength="1"') ?>
